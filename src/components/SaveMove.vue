<template>
  <div >
    <div :class="sidebartypes ? 'bigx-box' :'bigx-box2'">
      <div class="head">
        <div><img style="margin-top:10px;margin-left:20px;float: left;" src="../../public/photo/LOGO.png" width="50" height="50px"><span style="margin-left:5px;float: left;margin-top:25px;font-size:20px;">speed云盘</span></div>
      </div>
      <div class="boxx">
...
import {downloads,file,rename,getfile,recycler,movement,addfolder} from "../apis/index"
   ...
   created(){
      ...
      if(window.location.href.slice(0,24)!=="http://localhost:8080/s/"){
